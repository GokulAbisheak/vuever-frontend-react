        ...
        collections.map((item, index) => (
          ...
          >
            ...
            <div className="w-[550px] h-[450px] rounded-[10px] flex flex-col justify-center items-center gap-[30px]">
              ...
              <Link to={item.link}>
                <button className="px-[20px] py-[10px] bg-transparent border-[2px] border-black rounded-full uppercase font-bold text-md hover:bg-black hover:text-white duration-300">
                  {`View ${item.title}`}
                </button>
              </Link>
            </div>
